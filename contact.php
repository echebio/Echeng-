...
<div id="wrapper">
	<div id="header">
    <h1><a href="index.php"><img src="images/a.png"  width="150" height="150" class="logo" alt="James Buchanan Pub and Restaurant" /></a></h1>
        <ul id="mainnav">
			<li><a href="index.php">Home</a></li>
            <li><a href="gallery.php">Gallery</a></li>
            <li><a href="history.php">History</a></li>
            <li><a href="routes.php">Routes</a></li>
            <li><a href="location.php"></a></li>
    ...
    <div id="content">
    	<div id="gallerycontainer">
			<div class="portfolio-area" style="margin:0 auto; padding:140px 20px 20px 20px; width:820px;">	
				<div id="contactleft">
					YOUNG SHALL GROW MOTORS<br>
<br>
Festac, Opposite Odofun Local Government, 2nd Ave, Lagos, Nigeria.<br>
Phone:  +234809 619 6617<br><br>

YOUNG SHALL GROW MOTORS<br>
<br>
nO. 43, Awolowa Street, Apapa Local Government, Lagos, Nigeria.<br>
<br>
Phone: +234809 619 9919<br><br>
...
<div id="footer">
	<h4>+234809 619 6617 &bull; <a href="contact-us.php">Festac, Opposite Odofun Local Government, 2nd Ave, Lagos, Nigeria. </a></h4>
	<p>Hours of Operation&nbsp;&nbsp;&bull;&nbsp;&nbsp;Mon - Sun: 10:00 am - 12:00 am</p>
	<a href="index.php"><img src="images/a.png" width="50" height="50" alt="James Buchanan Pub and Restaurant" /></a>
	<p>&copy; Copyright 2017 Young Shall Grow Bus | All Rights Reserved <br /></p>
</div>
