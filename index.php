...
<div id="wrapper">
	<div id="header">
    <a href="index.php"><img src="images/a.png"  width="150" height="150" class="logo" alt="" s/></a>
        <ul id="mainnav">
    ...
    <div id="content">
    	<div id="rotator">
              <ul>
                    <li class="show"><img src="images/y1.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="images/y2.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="images/y3.jpg" width="861" height="379"  alt="" /></li>
                    <li><img src="images/y4.jpg" width="861" height="379"  alt="" /></li>
              </ul>
